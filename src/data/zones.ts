...
export const ZONES: Zone[] = [
  ...
  },
  {
    ...
    travelTime: 15, minLevel: 1, rewards: ['Обычные патроны', 'Бинт'],
  },
  {
    name: 'Военная база', difficulty: 15, className: 'zone-factory',
    allowedFactions: ['Военные'], description: 'Заброшенная военная база. Много ценного снаряжения.',
    travelTime: 25, minLevel: 3, rewards: ['Оружие', 'Броня', 'Моды'],
  },
  {
    ...
    travelTime: 10, minLevel: 1, rewards: ['Материалы'],
  },
  {
  ...
  },
  {
    ...
    travelTime: 30, minLevel: 4, rewards: ['Оружие', 'Чипы'],
  },
  {
    ...
    travelTime: 18, minLevel: 2, rewards: ['Припасы', 'Боеприпасы'],
  },
  {
    ...
    travelTime: 35, minLevel: 5, rewards: ['Легендарные предметы', 'Чипы'],
  },
];
