...
export const GAME_ITEMS: ItemDefinition[] = [,
  ...
  { name: 'Thompson', rarity: 'normal', slot: 'weapon2', stats: { damage: 9, accuracy: -0.1, punching: 0.01 }, ammoCapacity: 30, range: 9 },
  ...
  { name: 'SCAR-L', rarity: 'epic', slot: 'weapon2', stats: { damage: 11, punching: 0.02 }, ammoCapacity: 30, range: 10 },
  ...
  { name: 'Vector', rarity: 'superepic', slot: 'weapon2', stats: { damage: 7, speed: 0.2, crit: 0.03, accuracy: -0.1, vampir: 0.02 }, mods: {}, ammoCapacity: 30, range: 9 },
  ...
  { name: 'АШ-12', rarity: 'superepic', slot: 'weapon2', stats: { damage: 17, punching: 0.05, speed: -0.1, accuracy: -0.1, vampir: 0.02 }, mods: {}, ammoCapacity: 20, range: 9 },
  ...
  { name: 'Плазменный клинок', rarity: 'superepic', slot: 'weapon1', stats: { damage: 20, dpsEmi: 5, block: 0.01, vampir: 0.04, punching: 0.06, crit: 0.04 }, mods: {} },
  ...
  { name: 'Шлем монолита', rarity: 'epic', slot: 'head', stats: { armor: 3.5, block: 0.01, maxHp: 150 } },
  { name: 'Нагрудник монолита', rarity: 'epic', slot: 'armor', stats: { armor: 6, block: 0.015, maxHp: 250 } },
  { name: 'Перчатки монолита', rarity: 'epic', slot: 'gloves', stats: { armor: 2, block: 0.008 } },
  { name: 'Походные сапоги монолита', rarity: 'epic', slot: 'boots', stats: { armor: 2.5, block: 0.008, stamina: 0.02 } },
