...
export const GAME_ITEMS: ItemDefinition[] = [,
  ...
  },
  {
    ...
    rarity: 'superepic',
    slot: 'weapon2',
    stats: { damage: 11, speed: 0.25, crit: 0.02, punching: 0.02, accuracy: -0.4, evasion: -0.3 },
    ammoCapacity: 200,
    ammoType: 'mg',
    reloadAp: 5,
  },
  ...
  { name: 'M60', rarity: 'normal', slot: 'weapon2', stats: { damage: 11, speed: 0.05, punching: 0.02, accuracy: -0.25, evasion: -0.2 }, mods: {}, ammoCapacity: 100, ammoType: 'mg', reloadAp: 5 },
  { name: 'M249 SAW', rarity: 'epic', slot: 'weapon2', stats: { damage: 13, speed: 0.1, punching: 0.02, crit: 0.02, accuracy: -0.15, evasion: -0.2 }, mods: {}, ammoCapacity: 100, ammoType: 'mg', reloadAp: 5 },
  { name: 'PKM', rarity: 'epic', slot: 'weapon2', stats: { damage: 14, speed: 0.08, punching: 0.05, accuracy: -0.3, evasion: -0.25 }, mods: {}, ammoCapacity: 100, ammoType: 'mg', reloadAp: 5 },
  { name: 'ПКП «Печенег»', rarity: 'superepic', slot: 'weapon2', stats: { damage: 15, speed: 0.1, punching: 0.04, accuracy: -0.3, evasion: -0.25 }, mods: {}, ammoCapacity: 150, ammoType: 'mg', reloadAp: 5 },
  { name: 'M240', rarity: 'superepic', slot: 'weapon2', stats: { damage: 16, speed: 0.1, punching: 0.05, accuracy: -0.3, evasion: -0.3 }, mods: {}, ammoCapacity: 100, ammoType: 'mg', reloadAp: 5 },
