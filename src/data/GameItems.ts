...
export const GAME_ITEMS: ItemDefinition[] = [,
  ...
  { name: 'UZI', rarity: 'normal', slot: 'weapon2', stats: { damage: 6, speed: 0.18, accuracy: -0.2 }, ammoCapacity: 32, range: 8 },
  { name: 'Thompson', rarity: 'normal', slot: 'weapon2', stats: { damage: 9, speed: 0.06, accuracy: -0.2, punching: 0.01 }, ammoCapacity: 30, range: 8 },
  ...
  { name: 'AUG', rarity: 'epic', slot: 'weapon2', stats: { damage: 10, crit: 0.03, accuracy: 0.02 }, ammoCapacity: 30, range: 10 },
  { name: 'SCAR-L', rarity: 'epic', slot: 'weapon2', stats: { damage: 11, punching: 0.02 }, ammoCapacity: 30, range: 10 },
  { name: 'FN P90', rarity: 'epic', slot: 'weapon2', stats: { damage: 9, speed: 0.2, accuracy: -0.1 }, ammoCapacity: 50, range: 8 },
  ...
  { name: 'Vector', rarity: 'superepic', slot: 'weapon2', stats: { damage: 11, speed: 0.25, crit: 0.03, accuracy: -0.1, vampir: 0.02 }, mods: {}, ammoCapacity: 30, range: 9 },
