...
export const GAME_ITEMS: ItemDefinition[] = [,
  ...
  },
  {
    ...
    rarity: 'epic',
    slot: 'weapon1',
    stats: { damage: 10, block: 0.01, speed: -0.2, vampir: 0.03, punching: 0.045, crit: 0.03 },
    mods: {},
  },
  {
  ...
  },
  {
    ...
    rarity: 'superepic',
    slot: 'weapon1',
    stats: { damage: 20, block: 0.1, vampir: 0.04, punching: 0.06, crit: 0.04 },
    mods: {},
  },
  {
  ...
  { name: 'Шлем стража', rarity: 'normal', slot: 'head', stats: { block: 0.05, armor: 1 } },
  {
    name: 'Шлем агрессора',
    rarity: 'epic',
    slot: 'head',
    stats: { block: 0.05, armor: 1 },
  },
  {
    name: 'Шлем меткого снайпера',
    rarity: 'epic',
    slot: 'head',
    stats: { block: 0.05, armor: 1.5 },
  },
  {
    name: 'Костяной шлем',
    rarity: 'epic',
  ...
  },
  {
    ...
    rarity: 'superepic',
    slot: 'armor',
    stats: { armor: 7.5, maxHp: 500, regen: 0.1, block: 0.5 },
  },
  ...
  },
  {
    ...
    rarity: 'superepic',
    slot: 'armor',
    stats: { armor: 7.5, block: 0.3, maxHp: 50 },
  },
  ...
  { name: 'Сапоги охотника', rarity: 'normal', slot: 'boots', stats: { block: 0.05, armor: 1 } },
  {
    name: 'Ботинки из черепа',
    rarity: 'epic',
    slot: 'boots',
    stats: { maxHp: 10, block: 0.05 },
  },
  ...
  { name: 'Дубинка', rarity: 'normal', slot: 'weapon1', stats: { damage: 4, block: 0.05, vampir: 0.1, punching: 0.03, crit: 0.02, speed: 0.1 } },
  ...
  { name: 'Палаш', rarity: 'epic', slot: 'weapon1', stats: { damage: 11, block: 0.1, vampir: 0.03, punching: 0.045, crit: 0.03 } },
  ...
  { name: 'Плазменный клинок', rarity: 'superepic', slot: 'weapon1', stats: { damage: 20, dpsEmi: 5, block: 0.1, vampir: 0.04, punching: 0.06, crit: 0.04 }, mods: {} },
  ...
  { name: 'Шлем монолита', rarity: 'epic', slot: 'head', stats: { armor: 3.5, block: 0.1, maxHp: 150 } },
  { name: 'Нагрудник монолита', rarity: 'epic', slot: 'armor', stats: { armor: 6, block: 0.15, maxHp: 250 } },
  { name: 'Перчатки монолита', rarity: 'epic', slot: 'gloves', stats: { armor: 2, block: 0.08 } },
  { name: 'Походные сапоги монолита', rarity: 'epic', slot: 'boots', stats: { armor: 2.5, block: 0.08, stamina: 0.02 } },
  ...
  { name: 'Рукавицы кузнеца', rarity: 'epic', slot: 'gloves', stats: { armor: 2, block: 0.05 } },
  ...
  { name: 'Копыта демона', rarity: 'superepic', slot: 'boots', stats: { armor: 2.5, speed: 0.02, block: 0.1, stamina: 0.03 } },
  ...
  { name: 'Экзо-штаны', rarity: 'superepic', slot: 'pants', stats: { armor: 6, maxHp: 350, block: 0.3 } },
  ...
  { name: 'Шлем «Гром»', rarity: 'superepic', slot: 'head', stats: { armor: 9, block: 1, speed: -0.2, evasion: -0.2 }, unique: true },
  { name: 'Панцирь болотника', rarity: 'superepic', slot: 'armor', stats: { armor: 30, maxHp: 500, speed: -0.3 }, unique: true },
  { name: 'Броня «Стена»', rarity: 'superepic', slot: 'armor', stats: { armor: 20, block: 1.5, speed: -0.1 }, unique: true },
  ...
  { name: 'Кольчуга «Ратник»', rarity: 'superepic', slot: 'armor', stats: { armor: 15, block: 1, maxHp: 200, speed: -0.1 }, unique: true },
  ...
  { name: 'Поножи «Бастион»', rarity: 'superepic', slot: 'pants', stats: { armor: 11, block: 0.8, speed: -0.1 }, unique: true },
  ...
  { name: 'Поножи «Каратель»', rarity: 'superepic', slot: 'pants', stats: { armor: 13, block: 0.6, speed: -0.2, evasion: -0.2 }, unique: true },
  { name: 'Перчатки «Кузнец Зоны»', rarity: 'superepic', slot: 'gloves', stats: { armor: 6, block: 0.8, speed: -0.3 }, unique: true },
  ...
  { name: 'Рукавицы «Молот»', rarity: 'superepic', slot: 'gloves', stats: { armor: 7, block: 0.6, regen: 0.5, speed: -0.3 }, unique: true },
  { name: 'Перчатки «Сапёр»', rarity: 'superepic', slot: 'gloves', stats: { armor: 5, regen: 1, speed: -0.1 }, unique: true },
  { name: 'Краги «Титан»', rarity: 'superepic', slot: 'gloves', stats: { armor: 12, block: 1, speed: -0.2, evasion: -0.2 }, unique: true },
  { name: 'Сапоги «Сталкер»', rarity: 'superepic', slot: 'boots', stats: { armor: 6, evasion: 0.006, speed: -0.3 }, unique: true },
  { name: 'Берцы «Центурион»', rarity: 'superepic', slot: 'boots', stats: { armor: 11, block: 0.8, speed: -0.1 }, unique: true },
