...
> = {
  ...
  Феникс: [
    ...
    { count: 20, bonuses: { damage: 25, crit: 0.1, maxHp: 100, armor: 10, allDps: 10 } },
  ],
};
...
export const GAME_ITEMS: ItemDefinition[] = [
  ...
  },
  {
    ...
    slot: 'ammo',
    type: 'ammo',
    stats: { health: 500, block: 0.1, accuracy: -0.1 },
    timeLimit: 30,
    set: 'Бандиты',
  },
  {
  ...
  // --- Firearms ---
  {
    ...
    rarity: 'normal',
    slot: 'weapon2',
    stats: { damage: 6, crit: 0.03, accuracy: 1.0 },
  },
  ...
  },
  {
    ...
    rarity: 'normal',
    slot: 'weapon2',
    stats: { damage: 8, crit: 0.02, accuracy: 0.9 },
  },
  {
    name: 'Винтовка СВД',
    rarity: 'epic',
    slot: 'weapon2',
    stats: { damage: 15, crit: 0.05, accuracy: 1.1 },
  },
  {
    name: 'Дробовик',
    rarity: 'normal',
    slot: 'weapon2',
    stats: { damage: 12, accuracy: 0.7, armor: -2 },
  },
  {
    name: 'ППШ',
    rarity: 'normal',
  ...
  },
  {
    ...
    rarity: 'epic',
    slot: 'weapon2',
    stats: { damage: 20, crit: 0.08, accuracy: 1.2 },
  },
  {
    name: 'M134 Minigun',
    rarity: 'superepic',
    slot: 'weapon2',
    stats: { damage: 6, speed: 0.25, crit: 0.01 },
  },
  {
    name: 'Плазменная винтовка',
    rarity: 'superepic',
    slot: 'weapon2',
    stats: { damage: 14, crit: 0.06, dpsEmi: 8 },
  },
  ...
  { name: 'Бронежилет', rarity: 'normal', slot: 'armor', stats: { armor: 5, health: 100 } },
  {
    ...
    rarity: 'normal',
    slot: 'armor',
    stats: { armor: 8, health: 150, regen: 0.5 },
  },
  {
    name: 'Экзоскелет',
    rarity: 'epic',
  ...
  },
  {
    ...
    rarity: 'superepic',
    slot: 'armor',
    stats: { armor: 15, health: 500, regen: 1, block: 0.05 },
  },
  ...
  { name: 'Стальное кольцо', rarity: 'normal', slot: 'ammo', stats: { armor: 2, health: 50 } },
  {
    ...
    rarity: 'epic',
    slot: 'ammo',
    stats: { luck: 2, crit: 0.02, health: 50 },
  },
  {
    name: 'Кристалл регенерации',
    rarity: 'superepic',
    slot: 'ammo',
    stats: { regen: 2, health: 100 },
  },
  { name: 'Жетон наёмника', rarity: 'normal', slot: 'ammo', stats: { damage: 3, armor: 1 } },
  {
    name: 'Медальон выжившего',
    rarity: 'epic',
    slot: 'ammo',
    stats: { health: 150, regen: 1, evasion: 0.02 },
  },
  {
    name: 'Артефакт древних',
    rarity: 'superepic',
    slot: 'ammo',
    stats: { damage: 8, armor: 5, health: 200, crit: 0.04 },
  },
  {
    name: 'Костяной щит',
    rarity: 'epic',
