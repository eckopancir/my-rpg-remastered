...
export const CONSUMABLE_DEFS: ConsumableDef[] = [
  ...
  C('Рагу', 'food_ragu', '🍲', 190, '+15% HP. Рецепт: картошка + вода + мясо.'),
  C('Жареное мясо', 'food_fried_meat', '🍖', 300, '+20% HP. Рецепт: мясо × 2.'),
  C('Варёная картошка', 'food_boiled_potato', '🥔', 40, '+12% HP. Рецепт: картошка + вода.'),
