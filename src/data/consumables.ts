...
export const CONSUMABLE_DEFS: ConsumableDef[] = [
  ...
  // ─── Food ───────────────────────────────────────────────────────────
  C('Мясо', 'food_meat', '🥩', 150, 'Сырое мясо. Нужно приготовить.'),
  C('Картошка', 'food_potato', '🥔', 25, 'Сырая картошка. Нужно приготовить.'),
  C('Вода', 'food_water', '💧', 15, 'Чистая вода.'),
  C('Кипяченая вода', 'food_boiled_water', '♨️', 30, '+1% HP. Рецепт: вода × 2.'),
  C('Колбаса', 'food_sausage', '🌭', 50, '+2% HP.'),
  C('Яблоко', 'food_apple', '🍎', 20, '+1% HP.'),
  C('Тушёнка', 'food_stew', '🥫', 75, '+3% HP.'),
  C('Хлеб', 'food_bread', '🍞', 30, '+2% HP.'),
  C('Рагу', 'food_ragu', '🍲', 190, '+12% HP. Рецепт: картошка + вода + мясо.'),
  C('Жареное мясо', 'food_fried_meat', '🍖', 300, '+14% HP. Рецепт: мясо × 2.'),
  C('Варёная картошка', 'food_boiled_potato', '🥔', 40, '+10% HP. Рецепт: картошка + вода.'),
  C('Бутерброд', 'food_sandwich', '🥪', 80, '+5% HP. Рецепт: колбаса + хлеб.'),
  C('Жареная картошка', 'food_fried_potato', '🍟', 50, '+8% HP. Рецепт: картошка × 2.'),
  C('Кофе', 'food_coffee', '☕', 150, '+3% выносливости.'),
  C('Энергетик', 'food_energy', '🧃', 250, '+5% выносливости.'),
  C('Укол адреналина', 'food_adrenaline', '💉', 800, '+10% выносливости. Дорогой.'),
  C('Аптечка', 'food_firstaid', '🩹', 600, '+25% HP. Дорогая.'),
  C('Бинты', 'food_bandage', '🩼', 450, '+15% HP. Дорогие.'),
];
