...
export const CONSUMABLE_DEFS: ConsumableDef[] = [
  ...
  // ─── Food ───────────────────────────────────────────────────────────
  C('Мясо', 'food_meat', '🥩', 300, 'Сырое мясо. Нужно приготовить.'),
  C('Картошка', 'food_potato', '🥔', 50, 'Сырая картошка. Нужно приготовить.'),
  C('Вода', 'food_water', '💧', 30, 'Чистая вода.'),
  C('Колбаса', 'food_sausage', '🌭', 100, '+2% HP.'),
  C('Яблоко', 'food_apple', '🍎', 40, '+1% HP.'),
  C('Тушёнка', 'food_stew', '🥫', 150, '+3% HP.'),
  C('Хлеб', 'food_bread', '🍞', 60, '+2% HP.'),
  C('Рагу', 'food_ragu', '🍲', 380, '+15% HP. Рецепт: картошка + вода + мясо.'),
  C('Жареное мясо', 'food_fried_meat', '🍖', 600, '+20% HP. Рецепт: мясо × 2.'),
  C('Варёная картошка', 'food_boiled_potato', '🥔', 80, '+12% HP. Рецепт: картошка + вода.'),
  C('Бутерброд', 'food_sandwich', '🥪', 160, '+5% HP. Рецепт: колбаса + хлеб.'),
  C('Жареная картошка', 'food_fried_potato', '🍟', 100, '+8% HP. Рецепт: картошка × 2.'),
];
