...
export const CONSUMABLE_DEFS: ConsumableDef[] = [
  ...
  // ─── Food ───────────────────────────────────────────────────────────
  C('Мясо', 'food_meat', '🥩', 8, 'Сырое мясо. Нужно приготовить.'),
  C('Картошка', 'food_potato', '🥔', 4, 'Сырая картошка. Нужно приготовить.'),
  C('Вода', 'food_water', '💧', 3, 'Чистая вода.'),
  C('Колбаса', 'food_sausage', '🌭', 10, '+2% HP.'),
  C('Яблоко', 'food_apple', '🍎', 6, '+1% HP.'),
  C('Тушёнка', 'food_stew', '🥫', 12, '+3% HP.'),
  C('Хлеб', 'food_bread', '🍞', 7, '+2% HP.'),
  C('Рагу', 'food_ragu', '🍲', 0, '+15% HP. Рецепт: картошка + вода + мясо.'),
  C('Жареное мясо', 'food_fried_meat', '🍖', 0, '+20% HP. Рецепт: мясо × 2.'),
  C('Варёная картошка', 'food_boiled_potato', '🥔', 0, '+12% HP. Рецепт: картошка + вода.'),
  C('Бутерброд', 'food_sandwich', '🥪', 0, '+5% HP. Рецепт: колбаса + хлеб.'),
  C('Жареная картошка', 'food_fried_potato', '🍟', 0, '+8% HP. Рецепт: картошка × 2.'),
];
