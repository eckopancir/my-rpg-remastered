...
export const QUALITY_BONUSES: Record<string, Record<string, number>> = {
  ...
  armor: { regen: 2, block: 0.04, evasion: 0.0004, armor: 2, maxHp: 250, stamina: 1.5 },
  shield: { regen: 2, evasion: 0.0004, armor: 2, maxHp: 250 },
  gloves: { regen: 2, block: 0.04, evasion: 0.0004, armor: 2, maxHp: 250, stamina: 1.5 },
  boots: { regen: 2, block: 0.04, evasion: 0.0004, armor: 2, maxHp: 250, stamina: 1.5 },
  pants: { stamina: 1.5 },
