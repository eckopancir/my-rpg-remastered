    ...
    <header className={styles.header}>
      <div className={styles.left}>
        ...
        <nav className={styles.nav}>
          ...
          >
            <img src={hoverImg === 'range' || rangeOpen ? polygonOn : polygonOff} alt="Shooting Range" style={{ height: 75, width: 'auto', display: 'block' }} />
          </button>
          <button
            ...
            title="Equipment"
          >
            <img src={hoverImg === 'equipment' || equipmentOpen ? equipmentOn : equipmentOff} alt="Equipment" style={{ height: 75, width: 'auto', display: 'block' }} />
          </button>
          ...
          <button
            ...
            title="Inventory"
          >
            <img src={hoverImg === 'inventory' || inventoryOpen ? inventoryOn : inventoryOff} alt="Inventory" style={{ height: 75, width: 'auto', display: 'block' }} />
          </button>
          <NavLink
            to="/settings"
            className={({ isActive }) =>
