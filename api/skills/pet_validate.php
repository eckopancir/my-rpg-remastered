...
function petDefs() {
    return [
        ...
        'pb_t3_paw' => ['bear', 3, 1, 5, [], null],
        'pb_t4_wall' => ['bear', 4, 1, 5, [], null],
        'pb_t5_roar' => ['bear', 5, 1, 5, [], null],
        'pb_t6_rage' => ['bear', 6, 1, 4, [], null],
        'pb_t7_alpha' => ['bear', 7, 1, 5, [], null],
        'pw_t1_vamp' => ['wolf', 1, 10, 0, [], null],
        'pw_t1_spd' => ['wolf', 1, 10, 0, [], null],
        'pw_t2_dmg' => ['wolf', 2, 10, 5, [], null],
        'pw_t2_aura' => ['wolf', 2, 3, 5, [], null],
        'pw_t3_fangs' => ['wolf', 3, 1, 5, [], null],
        'pw_t4_shadow' => ['wolf', 4, 1, 5, [], null],
        'pw_t5_howl' => ['wolf', 5, 1, 5, [], null],
        'pw_t6_thirst' => ['wolf', 6, 1, 4, [], null],
