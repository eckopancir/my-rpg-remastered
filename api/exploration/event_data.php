...
$LOOT_TEXTS_RICH = [
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Осматриваем тайник — находим припасы и ценные вещи.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,4)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] вскрывают заржавевший замок — внутри дополнительный ящик.', 'noResourceText' => 'Без [Вода] замок не поддаётся — часть остаётся за решёткой.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
                ...
                ['text' => 'Торопливо собираем всё подряд — часть ломается при переноске.', 'weight' => 15, 'effects' => function($z,$l){return ['itemCount'=>rangeInt(0,1),'exp'=>E($l,2)];}, 'resourceCost' => 'Железо', 'resourceText' => '[Железо] скрепляют сломанное — спасаем часть добычи.', 'noResourceText' => 'Без [Железо] содержимое рассыпается — теряем трофеи.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return ['itemCount'=>-1];}],
            ],
        ],
    ],
    [
    ...
    'type' => 'story', 'noAutoBranch' => true, 'branch' => [
        'prompt' => '', 'outcomes' => [
            ...
            ['text' => 'Разбираешь старое оборудование лаборатории. Большинство деталей бесполезно, но некоторые механизмы ещё пригодны.', 'weight' => 15, 'effects' => function($z,$l){return ['itemCount'=>rangeInt(0,1),'exp'=>E($l,2)];}, 'resourceCost' => 'Железо', 'resourceText' => '[Железо] позволяет аккуратно снять защитные панели и сохранить детали.', 'noResourceText' => 'Без [Железо] часть механизмов ломается при разборе.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
        ],
    ],
],
[
    ...
    'type' => 'story', 'noAutoBranch' => true, 'branch' => [
        'prompt' => '', 'outcomes' => [
            ...
            ['text' => 'Разбираешь оборудование станции. Большая часть электроники мертва, но некоторые детали ещё ценны.', 'weight' => 15, 'effects' => function($z,$l){return ['itemCount'=>rangeInt(0,1),'chips'=>C($l,2),'exp'=>E($l,2)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] помогает очистить охлаждающую систему и сохранить компоненты.', 'noResourceText' => 'Без [Вода] перегретые детали быстро выходят из строя.', 'resourceEffects' => function($z,$l){return ['chips'=>C($l,1)];}, 'noResourceEffects' => function($z,$l){return [];}],
        ],
    ],
],
...
[
    ...
    'type' => 'story', 'noAutoBranch' => true, 'branch' => [
        'prompt' => '', 'outcomes' => [
            ...
            ['text' => 'Разбираешь оборудование лаборатории. Большая часть уже бесполезна, но некоторые детали ещё имеют ценность.', 'weight' => 15, 'effects' => function($z,$l){return ['itemCount'=>1,'exp'=>E($l,2)];}, 'resourceCost' => 'Железо', 'resourceText' => '[Железо] позволяет снять защитные корпуса оборудования.', 'noResourceText' => 'Без [Железо] механизмы повреждаются при разборе.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
        ],
    ],
],
...
[
    ...
    'type' => 'story', 'noAutoBranch' => true, 'branch' => [
        'prompt' => '', 'outcomes' => [
            ...
            ['text' => 'Отвечаешь на сигнал. Группа выживших делится координатами старого склада.', 'weight' => 20, 'effects' => function($z,$l){return ['chips'=>C($l,5),'itemCount'=>1];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] помогает настроить повреждённую частоту связи.', 'noResourceText' => 'Без [Изолента] связь прерывается, но координаты удаётся получить.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
...
[
        ...
        'type' => 'story', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'Сливаем остатки синтетического масла и снимаем уцелевший титановый щиток.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,2)];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] герметизирует поврежденную канистру, масло не проливается.', 'noResourceText' => 'Без [Изолента] половина ценного масла выливается в сухую грязь.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'story', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'В багажнике находим герметичную канистру с малом и ремень генератора.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] укрепляет потрескавшийся ремень, делая его пригодным.', 'noResourceText' => 'Без [Изолента] ремень рассыпается в труху от первого прикосновения.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'story', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'В лентоприемнике сохранились нерасстрелянные патроны.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] помогает связать патронные ленты для переноски.', 'noResourceText' => 'Без [Изолента] патроны рассыпаются в пыль.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
...
[
    ...
    'type' => 'story', 'noAutoBranch' => true, 'branch' => [
        'prompt' => '', 'outcomes' => [
            ['text' => 'В тренировочном секторе находишь защищённые шкафы с медицинскими комплектами и экипировкой.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'healPercent'=>RF(0.05,0.1)];}, 'resourceCost' => 'Инструменты', 'resourceText' => '[Инструменты] позволяют открыть медицинские контейнеры.', 'noResourceText' => 'Без [Инструменты] часть контейнеров остаётся закрыта.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
...
[
    ...
    'type' => 'story', 'noAutoBranch' => true, 'branch' => [
        'prompt' => '', 'outcomes' => [
            ['text' => 'Находишь технический вагон. Внутри сохранились инструменты инженеров.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'exp'=>E($l,3)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] очищает систему фильтрации вагона — открывается скрытый отсек.', 'noResourceText' => 'Без [Вода] часть найденных инструментов повреждена.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
...
[
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Снимаем рюкзак и изучаем карту — ценные ориентиры.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,5),'exp'=>E($l,3)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] утоляют жажду — ясно мыслим, карта открывает тайники.', 'noResourceText' => 'Без [Вода] карта выцвела — разбираем пометки с трудом.', 'resourceEffects' => function($z,$l){return ['exp'=>E($l,1)];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'Разбираем корпус на запчасти — микрочипы и провода.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>rangeInt(0,1),'exp'=>E($l,3)];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] изолируют контакты — микросхемы остаются целыми.', 'noResourceText' => 'Без [Изолента] микросхемы выгорают от замыкания.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Осторожно извлекаем коробку — инструменты в отличном состоянии.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,5)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] смазывают механизмы — инструменты блестят как новые.', 'noResourceText' => 'Без [Вода] инструменты проржавели — половину в утиль.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'Обыскиваем стеллажи — в щелях завалялись патроны.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] восстанавливают силы — находим схрон под полом.', 'noResourceText' => 'Без [Изолента] голод кружит голову — пропускаем тайник.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Вскрываем контейнер — боеприпасы в герметичной упаковке.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,3)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] вскрывают армейскую упаковку — внутри второй слой.', 'noResourceText' => 'Без [Вода] упаковка не поддаётся — бросаем, теряя боеприпасы.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Извлекаем тайник — запчасти и патроны в смазке.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,4)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] восстанавливают верстак — ремонтируем найденное оружие.', 'noResourceText' => 'Без [Вода] запчасти ржавые — половина в металлолом.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
                ...
                ['text' => 'Разбираем станки на запчасти — металл и механизмы.', 'weight' => 15, 'effects' => function($z,$l){return ['itemCount'=>rangeInt(0,1),'exp'=>E($l,2)];}, 'resourceCost' => 'Железо', 'resourceText' => '[Железо] идут на растопку — спасаем часть деревянных деталей.', 'noResourceText' => 'Без [Железо] станки гнилые — механизмы разрушаются.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return ['itemCount'=>-1];}],
            ],
        ],
    ],
    [
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'Роемся в личных вещах — находим драгоценности.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'exp'=>E($l,2)];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] заправляют горелку — свет выявляет тайник в обшивке.', 'noResourceText' => 'Без [Изолента] в темноте пропускаем драгоценности.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Снимаем рюкзак — содержимое в герметичных упаковках.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,5),'exp'=>E($l,3)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] заряжают маячок — находим базу десантников.', 'noResourceText' => 'Без [Вода] маячок мёртв — маршрут обрывается.', 'resourceEffects' => function($z,$l){return ['chips'=>C($l,2)];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'Разматываем сеть в поисках других трофеев.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>rangeInt(0,1),'exp'=>E($l,2)];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] разрезают узлы — сеть распутывается быстро.', 'noResourceText' => 'Без [Изолента] узлы гнилые — рвём сеть, теряем трофеи.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Забираем инструменты — отвёртки и мультиметр в работе.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'exp'=>E($l,3)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] дополняют набор — находим скрытые ящики с запчастями.', 'noResourceText' => 'Без [Вода] инструменты некомплектны — часть бесполезна.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Забираем пистолет и карту — револьвер в смазке, боеспособен.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,5)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] заправляют бак — УАЗик заводится, используем как тягач.', 'noResourceText' => 'Без [Вода] УАЗик мёртв — разбираем на запчасти.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
                ['text' => 'Осматриваем кузов — ящик с патронами под сиденьем.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1];}, 'resourceCost' => 'Изолента', 'resourceText' => '[Изолента] оживляют фару — видим схрон в багажнике.', 'noResourceText' => 'Без [Изолента] темно — пропускаем ящик с патронами.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
    ...
    [
        ...
        'type' => 'loot', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ['text' => 'Вскрываем посылку — {item} в идеальном состоянии.', 'weight' => 20, 'effects' => function($z,$l){return ['itemCount'=>1,'chips'=>C($l,4),'exp'=>E($l,2)];}, 'resourceCost' => 'Вода', 'resourceText' => '[Вода] распаковывают бережно — {item} не повреждены.', 'noResourceText' => 'Без [Вода] пузырчатка рвётся — часть {item} выпадает.', 'resourceEffects' => function($z,$l){return ['itemCount'=>1];}, 'noResourceEffects' => function($z,$l){return [];}],
