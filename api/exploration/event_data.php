    ...
    [
        ...
        'type' => 'story', 'noAutoBranch' => true, 'branch' => [
            'prompt' => '', 'outcomes' => [
                ...
                ['text' => 'Из затопленной кабины выскакивает кибер-болотник — сгнивший мутант с впаянными чипами.', 'weight' => 20, 'effects' => function($z,$l){return ['damagePercent'=>0.09,'chips'=>NC($l,2)];}, 'resourceCost' => 'Инструменты', 'resourceText' => '[Инструменты] коротят оголенный кабель на голове твари — мутант падаёт без чувств.', 'noResourceText' => 'Без [Инструменты] тварь успевает глубоко полоснуть когтями по предплечью.', 'resourceEffects' => function($z,$l){return ['damagePercent'=>-0.05];}, 'noResourceEffects' => function项目($z,$l){return ['damagePercent'=>0.04];}],
                ['text' => 'Грузовик неожиданно проседает deeper, зажимая ногу между бортом и корягой.', 'weight' => 20, 'effects' => function($z,$l){return ['damagePercent'=>0.07];}, 'resourceCost' => 'Железо', 'resourceText' => '[Железо] сработало как надежный домкрат — вывобождаем конечность.', 'noResourceText' => 'Без [Железо] приходится с болью вырывать ногу, растянув связки.', 'resourceEffects' => function($z,$l){return ['damagePercent'=>-0.04];}, 'noResourceEffects' => function($z,$l){return ['damagePercent'=>0.04];}],
