...
function getGameItems() {
  return [
    ...
    ['name' => 'Шлем джаггернаута', 'rarity' => 'superepic', 'slot' => 'head', 'set' => 'Джаггернаут', 'stats' => ['armor' => 20.625, 'health' => 825, 'block' => 0.66, 'regen' => 3.3, 'stamina' => 4.95, 'speed' => -0.033, 'accuracy' => -0.0165, 'evasion' => -0.033]],
    ['name' => 'Броня джаггернаута', 'rarity' => 'superepic', 'slot' => 'armor', 'set' => 'Джаггернаут', 'stats' => ['armor' => 42.5, 'health' => 1700, 'block' => 1.36, 'regen' => 6.8, 'stamina' => 10.2, 'speed' => -0.068, 'accuracy' => -0.034, 'evasion' => -0.068]],
    ['name' => 'Штаны джаггернаута', 'rarity' => 'superepic', 'slot' => 'pants', 'set' => 'Джаггернаут', 'stats' => ['armor' => 20.625, 'health' => 825, 'block' => 0.66, 'regen' => 3.3, 'stamina' => 4.95, 'speed' => -0.033, 'accuracy' => -0.0165, 'evasion' => -0.033]],
    ['name' => 'Перчатки джаггернаута', 'rarity' => 'superepic', 'slot' => 'gloves', 'set' => 'Джаггернаут', 'stats' => ['armor' => 20.625, 'health' => 825, 'block' => 0.66, 'regen' => 3.3, 'stamina' => 4.95, 'speed' => -0.033, 'accuracy' => -0.0165, 'evasion' => -0.033]],
    ['name' => 'Ботинки джаггернаута', 'rarity' => 'superepic', 'slot' => 'boots', 'set' => 'Джаггернаут', 'stats' => ['armor' => 20.625, 'health' => 825, 'block' => 0.66, 'regen' => 3.3, 'stamina' => 4.95, 'speed' => -0.033, 'accuracy' => -0.0165, 'evasion' => -0.033]],
